...
This repository shows the current development state of the administration shell. It is a container for definitions, models, specifications, and prototypes. The specification is based on previous achievements of ZVEI Workgroups.
